// copied from build
declare module 'littlejsengine/build/littlejs.esm.min' {
  /**
   ...
   *  @param {Boolean} [useWebGL=glEnable]
   *  @memberof Draw */
  export function drawTileScreenSpace(
    pos: Vector2,
    size?: Vector2,
    tileIndex?: number,
    tileSize?: Vector2,
   ...
   *  @param {Boolean} [useWebGL=glEnable]
   *  @memberof Draw */
  export function drawRectScreenSpace(
    pos: Vector2,
    size?: Vector2,
    color?: Color,
    angle?: number,
   ...
   *  @memberof Engine */
  export function engineObjectsCallback(
    pos?: Vector2,
    size?: number,
